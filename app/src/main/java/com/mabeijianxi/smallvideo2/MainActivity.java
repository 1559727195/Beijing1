...
public class MainActivity extends AppCompatActivity {
    ...
    public void go(View c) {
        ...
        String width = et_width.getText().toString();//360
        String height = et_height.getText().toString();//480
        String maxFramerate = et_maxframerate.getText().toString();//20
        String bitrate = et_bitrate.getText().toString();//580000
        String maxTime = et_maxtime.getText().toString();//6000
        String minTime = et_mintime.getText().toString();//1500
        String s = spinner_need_full.getSelectedItem().toString();
        boolean needFull = Boolean.parseBoolean(s);//false
