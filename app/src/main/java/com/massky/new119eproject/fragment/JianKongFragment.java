...
public class JianKongFragment extends BaseFragment1 {
    @Override
    ...
    protected int viewId() {
        return R.layout.jian_kong_frag;
    }
    ...
    public static JianKongFragment newInstance() {
        JianKongFragment newFragment = new JianKongFragment();
